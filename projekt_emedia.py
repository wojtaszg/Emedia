...
class Bmp:
    ...
    def fourier_transform(self):
        ...
        plt.subplot(143), plt.imshow(np.log(1 + np.abs(img_c3)), "gray"), plt.title("Moduł widma")
        plt.subplot(144), plt.imshow(np.log(1 + np.abs(img_xd)), "gray"), plt.title("Faza")
        plt.show()
